...
.zy-uni-calendar--mask-show {
  opacity: 1;
}

.zy-uni-calendar--fixed {
  position: fixed;
...
.zy-uni-calendar--ani-show {
  transform: translateY(0);
}

.zy-uni-calendar__content {
  background-color: #ffffff;
}

.zy-uni-calendar__content-mobile {
  // border-radius 代码区域
...
.zy-uni-calendar__header-mobile {
  //   padding: 10px;
  padding-bottom: 0;
}

.zy-uni-calendar--fixed-top {
  /* #ifndef APP-NVUE */
  display: flex;
  /* #endif */
  flex-direction: row;
...
.zy-uni-calendar--fixed-width {
  width: 50px;
}

.zy-uni-calendar__backtoday {
  position: absolute;
  right: 0;
  top: 25px;
  padding: 0 5px;
...
.zy-uni-calendar__header-btn-big-box {
  display: flex;
  justify-content: center;
}
.zy-uni-calendar__header-btn-box {
  /* #ifndef APP-NVUE */
  display: flex;
  /* #endif */
  flex-direction: row;
...
.zy-uni-calendar__header-btn {
  width: 10px;
  height: 10px;
  border-left-color: #0f56d5;
  border-left-style: solid;
  border-left-width: 2px;
  border-top-color: #0f56d5;
  border-top-style: solid;
  border-top-width: 2px;
}
.zy-uni-calendar__header-btn-one {
  width: 7px;
  height: 7px;
  border-left-color: #0f56d5;
  border-left-style: solid;
...
.zy-uni-calendar__header-date-box {
  display: flex;
  justify-content: center;
  align-content: center;
}
.zy-uni-calendar--left {
  transform: rotate(-45deg);
}

.zy-uni-calendar--right {
  transform: rotate(135deg);
}

.zy-uni-calendar__weeks {
  position: relative;
  /* #ifndef APP-NVUE */
  display: flex;
  /* #endif */
...
.zy-uni-calendar__weeks_header {
  height: 44px;
}
.zy-uni-calendar__weeks-item {
  flex: 1;
}

.zy-uni-calendar__weeks-day {
  flex: 1;
  /* #ifndef APP-NVUE */
  display: flex;
  /* #endif */
...
.zy-uni-calendar__weeks-day-text {
  font-size: 12px;
  color: #333333;
}

.zy-uni-calendar__box {
  position: relative;
  // padding: 0 10px;
  // padding-bottom: 7px;
}

.zy-uni-calendar__box-bg {
  /* #ifndef APP-NVUE */
  display: flex;
  /* #endif */
  justify-content: center;
