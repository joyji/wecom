<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column label="岗位编号" align="center" prop="id" min-width="100px" />
      <el-table-column label="岗位名称" align="center" prop="name" />
      <el-table-column label="岗位编码" align="center" prop="code" />
      <el-table-column label="岗位顺序" align="center" prop="sort" />
      <el-table-column label="岗位备注" align="center" prop="remark" />
      <el-table-column label="部门编号" align="center" prop="deptId" min-width="100px" />
      <el-table-column label="部门路径" align="center" prop="namePath" min-width="160px" />
